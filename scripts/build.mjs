...
const paths = [...(await Promise.all(dirs.map(d => walk(resolve(root, d))))).flat(),
  ...['index.html', 'labs.html', 'laser.html', 'gunship.html', 'settings.html', 'styles.css', 'app.css', 'manifest.webmanifest', 'favicon.svg', 'sw.js', 'ATTRIBUTIONS.md', 'ROADMAP.md', 'DEVLOG.md', 'PRACTICES.md', 'docs/FUNMAP.md'].map(p => resolve(root, p))]
