...
export const EXPLOSION_USES = Object.freeze({
  // radii from the owner's brief (a cell is 10 m): the rotary half a cell across, the Bofors a cell, the 105 about three
  'gunship.rotary': Object.freeze({ module: 'rotary-pop', scale: 0.55 }),    // 25 mm: 4.5 m module, ~2.5 m, 0.4 s
  'gunship.bofors': Object.freeze({ module: 'bofors-burst', scale: 0.45 }),  // 40 mm: 11 m module, ~5 m, 1.2 s
  'gunship.heavy': Object.freeze({ module: 'howitzer-blast', scale: 0.47 }), // 105 mm: 32 m module, ~15 m, 3 s
