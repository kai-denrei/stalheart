  ...
  lancer:   { shot: SHOT('lance', 7, 11, 42, { beamColor: 0x4dff86 }),
    ...
    impact: FX(['spark', 'flash', 'ember'], 0.7,
      ...
      { sparkCount: 20, sparkSpeed: 3, sparkSpread: 0.45, sparkGravity: 20,
        ...
        emberDrag: 0.55 }) },
  needle: { shot: SHOT('round', 9, 8, 100),
    muzzle: FX(['flash','spark'],.55,{flash:0xe8f6ff,spark:0xb9e4ff},{flashLife:.08,sparkCount:12}),
    impact: FX(['spark','flash','debris'],.85,{spark:0xc9eaff},{ringEnd:.2,debrisCount:8}) },
