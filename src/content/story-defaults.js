...
// least `margin` hops shorter through the back than through the gate. The collapse shot holds `hold` seconds over the mouth.
export const STORY_BACK_DOOR = Object.freeze({ maxCells: 2, reachShare: 0.5, flank: 4, hops: Object.freeze([25, 35]), margin: 20, hold: 2.5 });
