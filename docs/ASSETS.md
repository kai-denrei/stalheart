...
The Astro industrial expansion pins five additional intact assets at the same upstream revision in `astro-industry-assets.lock.json`: assembly line, warehouse scene, solar power complex, micro-reactor complex and Fortification foundation tile. Models and animations by jelaludo under the same attribution terms. Runtime batching preserves every animated node and solar tracker hinge; repeated foundation tiles use material-group instancing. Measured industrial mesh budgets: assembly 97,064 triangles / 333 batches, cargo 23,452 / 8, solar 131,236 / 45, reactor 19,900 / 7. Foundation geometry is 2,200 triangles per tile and five shared material batches for the network.
