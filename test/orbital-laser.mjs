...
assert.deepEqual(Object.keys(LASER_AUDIO), [LASER_SOUNDS.burn], 'the burn loop is the laser sound that exists');
assert.equal(LASER_AUDIO.laser_burn.file, 'assets/audio/laser_burn_ground.wav');
